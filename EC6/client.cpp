...
int main(int argc, char *argv[])
{
    ...
    if (!h2.isValidPortNumber(argv[1]))
    {
    ...
    char input[helper2::MAX_MESSAGE];
    ...
    // get feedback
    char feedback[helper2::MAX_MESSAGE];

    if (recv(clientSocket, &feedback, sizeof(char) * helper2::MAX_MESSAGE, 0) == -1)
    {
