...
static const char* VoteManager_method_names[] = {
  ...
  "/protos.VoteManager/shuttheserver",
};
...
VoteManager::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_shuttheserver_(VoteManager_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status VoteManager::Stub::shuttheserver(::grpc::ClientContext* context, const ::protos::Empty& request, ::protos::Response* response) {
  return ::grpc::internal::BlockingUnaryCall< ::protos::Empty, ::protos::Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_shuttheserver_, context, request, response);
}

void VoteManager::Stub::experimental_async::shuttheserver(::grpc::ClientContext* context, const ::protos::Empty* request, ::protos::Response* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::protos::Empty, ::protos::Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_shuttheserver_, context, request, response, std::move(f));
}

void VoteManager::Stub::experimental_async::shuttheserver(::grpc::ClientContext* context, const ::protos::Empty* request, ::protos::Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_shuttheserver_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::protos::Response>* VoteManager::Stub::PrepareAsyncshuttheserverRaw(::grpc::ClientContext* context, const ::protos::Empty& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::protos::Response, ::protos::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_shuttheserver_, context, request);
}

::grpc::ClientAsyncResponseReader< ::protos::Response>* VoteManager::Stub::AsyncshuttheserverRaw(::grpc::ClientContext* context, const ::protos::Empty& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncshuttheserverRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
VoteManager::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      VoteManager_method_names[1],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< VoteManager::Service, ::protos::Empty, ::protos::Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](VoteManager::Service* service,
             ::grpc::ServerContext* ctx,
             const ::protos::Empty* req,
             ::protos::Response* resp) {
               return service->shuttheserver(ctx, req, resp);
             }, this)));
}
...
::grpc::Status VoteManager::Service::shuttheserver(::grpc::ServerContext* context, const ::protos::Empty* request, ::protos::Response* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
