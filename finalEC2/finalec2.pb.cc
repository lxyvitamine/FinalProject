...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_finalec2_2eproto[2];
...
const char descriptor_table_protodef_finalec2_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\t2@\n\013VoteManager\0221\n\014parseUserCmd\022\017.pr"
  "otos.Request\032\020.protos.Responseb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_finalec2_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_finalec2_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_finalec2_2eproto = {
  false, false, descriptor_table_protodef_finalec2_2eproto, "finalec2.proto", 158,
  &descriptor_table_finalec2_2eproto_once, descriptor_table_finalec2_2eproto_sccs, descriptor_table_finalec2_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_finalec2_2eproto::offsets,
  file_level_metadata_finalec2_2eproto, 2, file_level_enum_descriptors_finalec2_2eproto, file_level_service_descriptors_finalec2_2eproto,
};
